...
function MessageSender() { 
    ...
    const handleSubmit = (e) => {
        ...
        db.collection('posts').add({
            message: input,
            timestamp: firebase.firestore.FieldValue.serverTimestamp(), /* using the server timestamp, this includes worldwide time zones. renders it correctly depending on the destination. */
